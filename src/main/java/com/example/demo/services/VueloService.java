...
//         if (dto.get() != null) {
//             Tripulantes Tripulantes = TripulantesRepository.findById(dto.getTripulantesId())
//                 .orElseThrow(() -> new RuntimeException("Tripulantes no encontrado"));
//             vuelo.setTripulantess(Tripulantes);
//         }
...
//         if (vuelo.getTripulantess() != null) {
//             dto.setTripulantesId(vuelo.getTripulantess().getId());
//             dto.setTripulantesNombre(vuelo.getTripulantess().getNombre()); // or getNombreCompleto
//         }
